...
$html = '<h1 style="text-align:center">Laporan Publish Karya Seniman</h1>
    ...
    <b>Periode : '.$start_date.' s/d '.$end_date.'</b>
';
...
$table .='<tr>
            ...
            <th style="border:1px solid black;text-align:center"><b>Creator</b></th>
            </tr>';
            if(is_object($selectcontent) || is_array($selectcontent)){
                foreach($selectcontent as $record){
                    $table .= '<tr>
