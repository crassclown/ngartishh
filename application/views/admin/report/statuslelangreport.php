...
if($statuslelang == 0 || $statuslelang == '0'){
    $html = '<label>Status Lelang : Masih berlangsung atau sedang berjalan</label>';
}
if($statuslelang == 1 || $statuslelang == '1'){
    $html = '<label>Status Lelang : Sudah berakhir</label>';
}
...
$table .='<tr>
            ...
            <th style="border:1px solid black;text-align:center"><b>Seniman / Pemilik</b></th>
            <th style="border:1px solid black;text-align:center"><b>Tanggal Berakhir</b></th>
            </tr>';
            if(is_object($varstatus) || is_array($varstatus)){
                foreach($varstatus as $record){
                    $table .= '<tr>
                                ...
                                <td style="border:1px solid black;text-align:center;"><br /><br />'.$record->fullname.'</td>
                                <td style="border:1px solid black;text-align:center;"><br /><br />'.$record->end_date.'</td>
                                </tr>';
                }
            }else{
                $table .= '<tr>
