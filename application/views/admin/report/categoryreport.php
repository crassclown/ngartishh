						...
						<div class="col-md-6">
							<div class="pmd-card pmd-z-depth pmd-card-custom-form">
								<div class="pmd-card-body"> 
									<form action="<?php echo base_url('c_admin/get_category');?>" method="POST">
										<!-- Regular Input -->
										<div class="form-group pmd-textfield">
											<label for="start_date" class="control-label">Category</label>
										...
										<button id="cek" name="cek" type="submit" class="form-control" value="Cek">Check</button>
                                    </form>									
								</div>
							</div>
				...
				<div class="component-box">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="pmd-card pmd-z-depth pmd-card-custom-form">
								<div class="pmd-card-body"> 
									<form action="<?php echo base_url('c_admin/get_auction');?>" method="POST">
										<!-- Regular Input -->
										<div class="form-group pmd-textfield">
											<label for="start_date" class="control-label">Status Auction</label>
											<select name="status" class="form-control" id="status" style="width:100%;">
                                                <option value=""></option>
                                                <option value="0">Not Finished</option>
                                                <option value="1">Already Complete</option>
                                            </select>
										</div>
...
<script>
    $(document).ready(function () {
        ...
        $("#status").select2({
            placeholder: "Please select the status auction"
        });
    });
</script>
</body>
