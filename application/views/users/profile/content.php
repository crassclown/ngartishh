                    ...
                    <article class="col-md-4 col-lg-3 isotopeItem webdesign">
                            <div class="space">
                                <div class="portfolio-item">
                                    <button type="button" class="btn btn-info btn-lg modal-right " data-toggle="modal" title="Notification" data-target="#myModal"><i class="material-icons " style="font-size:40px;">file_upload</i></button>
                                </div>
                            </div>
                        </article>
