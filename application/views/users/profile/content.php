					...
					<article class="col-md-4 col-lg-3 isotopeItem webdesign">
						<div class="space">
							<div class="portfolio-item">
								<button type="button" class="btn btn-info btn-lg modal-right " data-toggle="modal" title="Notification" data-target="#myModal">
				...
				<?php foreach($follower as $fer){ ?>
					<div class="content-modal-follow">
						...
						<span class="modal-nama" style="text-transform:capitalize">
							<p>
							<b><?php echo $fer->fullname ?></b>
							</p><?php echo $fer->phone ?>
						</span>
			...
			<div class="modal-content">
				...
				<?php foreach($following as $fing){ ?>
					<div class="content-modal-follow">
						...
						<span class="modal-nama" style="text-transform:capitalize">
							<p>
							<b><?php echo $fing->fullname ?></b>
							</p><?php echo $fing->phone ?>
						</span>
						<button class="button-modal-follow btn-info"> follow</button>
					</div>
				<?php } ?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="content-modal-follow">
                            ...
                            <span class="modal-nama"><p><b>Nama Lengkap</b></p>Username</span>
                            <button class="button-modal-follow btn-info"> follow</button>
                        </div>
                        <div class="content-modal-follow">
                            <div class="foto-profil-modal-follow">
