...
<!-- Modal restrict -->
<div class="modal fade" id="modal-restrict-lelang" role="dialog">
    <div class="modal-dialog">
                ...
                <div class="modal-content ">
                    ...
                    <div class="modal-body ">
                        <div class="padding-modal-body">
							Anda masih memiliki lelang yang belum berakhir
                        </div>
                        <div class="modal-footer">
                        <button type="button" class="btn btn-default" id="btnpost" data-dismiss="modal"> Close</button>
                        </form>
                    	</div>
					</div>
				</div>
