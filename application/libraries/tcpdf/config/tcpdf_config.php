 ...
 */
define ('PDF_HEADER_LOGO', 'Ngartish.png');
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Ngartish');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Galeri Online Pertama di Indonesia \nCiledug Raya - Petukangan Utara, DKI Jakarta");
